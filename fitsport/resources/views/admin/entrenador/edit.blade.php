        ...
        <form action="">
            <div class="flex">
                <div class="w-1/2 mr-2">
                    ...
                    <input type="text" id="nombre" class="w-full mt-1 p-2 rounded" placeholder="Ingresa tu nombre">
                </div>
                <div class="w-1/2 mr-2">
                    <label for="telefono" class="text-lg font-bold">Teléfono:</label>
                    <input type="text" id="telefono" class="w-full mt-1 p-2 rounded" placeholder="Ingresa tu teléfono">
                </div>
                <div class="w-1/2 ml-2">
                    <label for="hora" class="text-lg font-bold">Hora:</label>
                    <input type="time" id="hora" class="w-full mt-1 p-2 rounded" placeholder="Ingresa tu hora semanal">
                </div>
                <div class="w-1/2 ml-2">
            ...
            <div class="flex text-end justify-end">
                ...
                <a href="{{route('gymBoxes.index')}}" type="submit" class="mt-4 px-4 py-2 bg-white text-black font-semibold rounded-2xl hover:bg-blue-600">Cancelar</a>   
            </div>
        </form>
    </div>
</div>

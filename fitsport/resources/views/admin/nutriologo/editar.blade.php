        ...
        <form action="{{route('admNutriologo.update')}}" class="text-white rounded-lg p-4" enctype="multipart/form-data" method="POST" novalidate>
            ...
            <div class="flex">
                ...
                <div class="w-1/2 ml-2 mb-0">
                    ...
                    <input type="time" name="hora" style="color:black" id="hora" class="w-full mt-1 p-2 border border-white rounded-lg focus:outline-none focus:border-blue-300 @error('hora') border-red-500 @enderror" value="{{$nutriologo->horaEntrada}}" placeholder="Ingresa la hora">
                    @error('hora')
                        <p style="background-color: #f56565; color: #fff;margin-top: 0.5rem;border-radius: 0.5rem;font-size: 0.875rem; padding: 0.5rem; text-align: center;" class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                            {{$message}}
                        </p>    
                ...
                <div class="w-1/2 ml-2">
                    ...
                    <div class="image-input-container">
                        <label for="imagen">
                            ...
                            <!-- Imagen seleccionada -->
                            <span class="selected-image" style="background-image: url('{{ asset('ImgNutriologo/' . $nutriologo->imagen) }}');">
            ...
            <div class="flex" >
                <div class="w-3/4 mr-2" style="width: 80%;">
                    ...
                    <input type="number" style="color:black" id="cedula" name = "cedula" class="w-full mt-1 p-2 border border-white rounded-lg focus:outline-none focus:border-blue-300 @error('cedula') border-red-500 @enderror" value="{{$nutriologo->cedula}}" placeholder="Ingresa una descripción" placeholder="Ingresa tu cedula">
                    @error('cedula')
                        <p style="background-color: #f56565; color: #fff;margin-top: 0.5rem;border-radius: 0.5rem;font-size: 0.875rem; padding: 0.5rem; text-align: center;" class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">
                            {{$message}}
                        </p>    
